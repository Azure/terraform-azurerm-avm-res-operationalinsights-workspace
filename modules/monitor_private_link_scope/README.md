...
- Creates Monitor Private Link Scope
...
### <a name="input_monitor_private_link_scope_resource_group_name"></a> [monitor\_private\_link\_scope\_resource\_group\_name](#input\_monitor\_private\_link\_scope\_resource\_group\_name)

Description: (Required) Specifies the name of the Resource Group in which the Monitor Private Link Scope should exist. Changing this forces a new resource to be created
...
Description: (Optional) The name of the Azure Monitor Private Link Scoped Service. Changing this forces a new resource to be created.
